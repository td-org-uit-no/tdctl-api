...
from ..models import Member, MemberDB, MemberInput, MemeberUpdate, AccessTokenPayload
...
@ router.put('/')
def update_member(request: Request, memberData: MemeberUpdate, token: AccessTokenPayload=Depends(authorize)):
    db=get_database(request)
